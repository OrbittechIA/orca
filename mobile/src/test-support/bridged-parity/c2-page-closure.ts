 ...
 * everything they import, 3767 modules of which 428 are this repository's own. 72 families and 275
 ...
 * goldens, and a count lets one of the other 521 pay for a closure golden that stopped replaying.
 *
 ...
 * shell's own families are not the page's. The family set is the same 72 once those two are
 ...
 * Native Work Item Start added its two structured families, the
 ...
 * domain adds. C5's closure pins those same 24 and no family C2 reaches beyond them, so a golden
 * pinned twice is pinned once here.
 *
 * **What 275 certified does not say.** Six of the 72 families have no byte-identical golden at all
